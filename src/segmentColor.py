...
class edgeFilter:
    def __init__(self, nodename,imgTopic,depthTopic,outEdgesTopic,queue_size=10,slop=0.25):
        rospy.init_node(nodename)
        self.bridge = CvBridge()
        self.edgePub = rospy.Publisher(outEdgesTopic,Image,queue_size=10)
    ...
    def gotRGBDimage(self, rgb, depth):
        ...
        depthMask = bytescale(imdepth,900,1200)#[:,300:600]  # bytescale and crop
